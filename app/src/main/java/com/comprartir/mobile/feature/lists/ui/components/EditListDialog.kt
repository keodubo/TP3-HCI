...
import com.comprartir.mobile.lists.presentation.EditListUiState
    ...
    Dialog(
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    text = stringResource(id = R.string.lists_edit_dialog_title),
                ...
                Row(
                    ...
                    Button(
                        ...
                        Text(text = stringResource(id = R.string.lists_edit_dialog_confirm))
                    }
                }
            }
        }
